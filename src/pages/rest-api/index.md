...
- #### **Relationships and Resources**
  ...
  - Resources can have `one-to-one`, `one-to-many`, `many-to-many` relationships etc. Mapping them correctly is crucial.
  - **One-to-One** Mapping
  ...
  - **One-to-Many** Mapping
       ...
       For example, `Tickets/145/messages/4` suggests a one-to-many relationship between `tickets` and `messages`. Meaning `1` ticket has `N` messages. Message isn't a standalone resource. You can't have `/messages/4`.
